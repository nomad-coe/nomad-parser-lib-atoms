...
For lib-atoms please provide at least the files from this table if applicable to your
...
```
git clone https://gitlab.mpcdf.mpg.de/nomad-lab/parser-lib-atoms parser-lib-atoms
pip install -e parser-lib-atoms
```
